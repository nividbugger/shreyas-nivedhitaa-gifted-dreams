...
interface RegistryContextType {
  ...
  addCashGift: (guestName: string, from: string, message: string, amount?: string) => void;
...
export const RegistryProvider: React.FC<RegistryProviderProps> = ({ children }) => {
  ...
  const addCashGift = (guestName: string, from: string, message: string, amount: string = "Amount not specified") => {
    const newGift: Gift = {
      id: Date.now().toString(),
      type: "cash",
      amount,
